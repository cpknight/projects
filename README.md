...
| `Alpes-0.1` | Materials and structure concept test (RPi Zero simulated payload). _ |
...
| `` | _Lorem_ |
| `` | _Lorem_ |
| **`PROJECT NAME`** | **Project Description**: | [PAR-Aero-Reponame](https://github.com/cpknight/PAR-AERO-Reponame) |
| `` | _Lorem_ |
| `` | _Lorem_ |
| `` | _Lorem_ |
| `` | _Lorem_ |
...
Sarthe
SARTHE			Aerial Recconnaissance Convolutional Neural Networks
